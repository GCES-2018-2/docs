...
| [#253](https://github.com/SIGS-UnB/core/issues/253) | 1. Redução do número de parâmetros do método 'run_all_allocation_date' de 5 para 4; 2. Redução do método 'run_allocation' (ifs desnecessários); 3. Redução do método 'run_all_allocation_date' decompondo parte dele em outro método ; 4. Remoção de métodos em JS não utlizados: ajaxReloadTable e generateTable; 5. Redução do método 'make_cell' decompondo parte dele em outro método. | Concluída |  [Lucas S. Souza](https://github.com/lucassoaresouza) |
| [#253](https://github.com/SIGS-UnB/core/issues/253) |  Redução da complexidade cognitiva por composição dos métodos: 1. save_in_period, 2. get_rooms, 3. validate_courses, 4.     generate_by_room. | Concluída | [Stéfane Souza](https://github.com/stefanesouza) |
...
| [#260](https://github.com/SIGS-UnB/core/issues/260) |  Melhorar visualização da home | Concluída | [Adrianne Alves](https://github.com/drianne) |
| [#262](https://github.com/SIGS-UnB/core/issues/262) |  Apresentar apenas prédios do coordenador na alocação | Concluída | [Adrianne Alves](https://github.com/drianne) |
